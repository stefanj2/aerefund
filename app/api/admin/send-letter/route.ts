...
function buildClaimbrief(claim: Record<string, unknown>) {
  ...
  const text = [
    ...
    '',
    `Aerefund.nl (GoodbyeGuru BV, hierna "Aerefund") deelt u mede dat zij als cessionaris de vordering van de heer/mevrouw ${fullName} (hierna "cedent") op uw maatschappij heeft overgenomen op grond van artikel 3:94 Burgerlijk Wetboek. De overdracht is geschied door middel van een elektronische akte, waarbij de cedent via het Aerefund-platform uitdrukkelijk heeft ingestemd met de vorderingsoverdracht. Aerefund is met ingang van de datum van cessie de rechthebbende en verzoekt u betaling uitsluitend aan Aerefund te verrichten.`,
    '',
    'VLUCHTGEGEVENS',
    ...
    '',
    'VORDERING',
    'Op grond van Verordening (EG) 261/2004 heeft de cedent recht op compensatie wegens bovenstaande vertraging van meer dan 3 uur bij aankomst.',
    '',
...
<p>Aerefund.nl (GoodbyeGuru BV, hierna &ldquo;Aerefund&rdquo;) deelt u mede dat zij als <strong>cessionaris</strong> de vordering van de heer/mevrouw <strong>${fullName}</strong> (hierna &ldquo;cedent&rdquo;) op uw maatschappij heeft overgenomen op grond van <strong>artikel 3:94 Burgerlijk Wetboek</strong>. De overdracht is geschied door middel van een elektronische akte, waarbij de cedent via het Aerefund-platform uitdrukkelijk heeft ingestemd met de vorderingsoverdracht. Aerefund is met ingang van de datum van cessie de rechthebbende en verzoekt u betaling <strong>uitsluitend aan Aerefund</strong> te verrichten.</p>
...
<h2>Vordering</h2>
<p>Op grond van <strong>Verordening (EG) 261/2004</strong> heeft de cedent recht op compensatie wegens bovenstaande vertraging van meer dan 3 uur bij aankomst.</p>
